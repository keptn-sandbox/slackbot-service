...
def help_reply(message):
    ...
    reply.append(u'•`{0}`'.format('@<Botname> get projects | returns projects running in keptn'))
    reply.append(u'•`{0}`'.format('@<Botname> get services of <project> | returns services running under a project'))
